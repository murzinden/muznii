                ...
                <header className={cn(s.header)}>
                    <nav>
                        <ul className={cn(s.header__nav, {[s.open]: isMenuOpen})}>
                            ...
                            <li><Link to="/reviews" className={cn(s.header__link)} onClick={closeMenu}>Отзывы</Link></li>
                            <li><Link to="/team" className={cn(s.header__link)} onClick={closeMenu}>Команда</Link></li>
                            <li><Link to="/assistants" className={cn(s.header__link)} onClick={closeMenu}>Наши помощники</Link></li>
                            <li><Link to="/social" className={cn(s.header__link)} onClick={closeMenu}>Социальная деятельность</Link></li>
                            <li><Link to="/volunteering" className={cn(s.header__link)} onClick={closeMenu}>Волонтерство</Link></li>
                            <li><Link to="/order" className={cn(s.header__link)} onClick={closeMenu}>Заказать</Link></li>
                        </ul>
                    </nav>
